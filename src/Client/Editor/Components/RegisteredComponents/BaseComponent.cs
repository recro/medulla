...
using Medulla.Client.Editor.Components.EditorView;
using Medulla.Client.Editor.Components.PropertiesWindow;
using Medulla.Client.Editor.Library.Abstractions.Environment.EnvironmentAbstractionHandler;
using Medulla.Client.Editor.Library.Utilities.Unique;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Web;

namespace Medulla.Client.Editor.Components.RegisteredComponents
{
    /// <summary>
    /// Base Component
    /// </summary>
        ...
        public void UpdatePropertiesWindow(EditorPage editor, UniqueId? uniqueId)
        {
            ...
            if (DoesImplementFonts())
            {
                properties.PropertyList.Add(new Property
                {
                    ...
                    InputType = "Medulla.Client.Editor.Components.PropertiesWindow.PropertyComponents.Checkbox"
                }
                );
            }
            if (DoesImplementMargin())
            {
                properties.PropertyList.Add(new()
                {
                    ...
                    InputType = "Medulla.Client.Editor.Components.PropertiesWindow.PropertyComponents.Dropdown"
                }
                );
                properties.PropertyList.Add(new()
                {

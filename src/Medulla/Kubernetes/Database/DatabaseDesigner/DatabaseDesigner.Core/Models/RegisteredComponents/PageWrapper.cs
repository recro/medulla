...
namespace DatabaseDesigner.Core.Models.RegisteredComponents
{
    public class PageWrapper : NodeModel
    {
        public PageWrapper(Point position = null) : base(position, RenderLayer.HTML)
        {

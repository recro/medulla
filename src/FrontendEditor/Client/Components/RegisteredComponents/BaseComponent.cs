...
using Medulla.FrontendEditor.Client.Components.Editor.PropertiesWindow;
using Medulla.FrontendEditor.Client.Library.Abstractions.Environment.EnvironmentAbstractionHandler;
using Medulla.FrontendEditor.Client.Library.Utilities.Unique;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Web;

namespace Medulla.FrontendEditor.Client.Components.RegisteredComponents
{
    /// <summary>
    /// Base Component
    /// </summary>
    public abstract class BaseComponent : ComponentBase
    {
        ...
        /// </summary>
        [Parameter]
        public Medulla.FrontendEditor.Client.Components.Editor.Editor Editor { get; set; } = default!;
        /*
         * These parameters are system required
         */
        ...
        /// After Add Component
        /// </summary>
        protected abstract void AfterAddComponent(Medulla.FrontendEditor.Client.Components.Editor.Editor editor, UniqueId uniqueId);
        ...
        public void UpdatePropertiesWindow(Editor.Editor editor, UniqueId? uniqueId)
        {
            ...
            if (this.DoesImplementFonts())
            {
                properties.PropertyList.Add(new Property
                {
                    ...
                    InputType = "Medulla.FrontendEditor.Client.Components.Editor.PropertiesWindow.PropertyComponents.Checkbox"
                }
                );
            }
            if (this.DoesImplementMargin())
            {
                properties.PropertyList.Add(new()
                {
                    ...
                    InputType = "Medulla.FrontendEditor.Client.Components.Editor.PropertiesWindow.PropertyComponents.Dropdown"
                }
                );
                properties.PropertyList.Add(new()
                {
